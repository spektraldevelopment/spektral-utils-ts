...
describe("URL Module", () => {
    ...
    describe("getURL", () => {
        ...
        it("should have values for each property that match the window.location object", () => {
            ...
            expect(url.href).toBe("https://developer.mozilla.org/en/foobar?foo=bar&bar=foo#test=hello");
    ...
    describe("isValidURL", () => {
        ...
        it("should return a boolean", () => {
            expect(typeof isValidURL("https://developer.mozilla.org")).toBe("boolean");
        });
